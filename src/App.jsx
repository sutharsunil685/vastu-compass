...
const VASTU_RULES = {
  main_entrance: {
    ...
    forbidden: ["South-West", "South"],
    priority: "P1",
    remedy: "Install yellow marble threshold and Copper Swastika helix.",
    science: "Captures vital morning UV rays and positive geomagnetic flow.",
  },
  kitchen: {
    ideal: ["South-East"],
    forbidden: ["North-East", "South-West"],
    priority: "P1",
    remedy: "Keep a copper helix in SE corner; face East while cooking.",
    science: "Combines solar heat with SE wind patterns for moisture control.",
  },
  master_bedroom: {
    ideal: ["South-West"],
    forbidden: ["North-East", "Center"],
    priority: "P1",
    remedy: "Use heavy wooden bed and shades of yellow/earth.",
    science: "South-West is the most stable thermal zone for long-term rest.",
  },
  children_bedroom: {
    ideal: ["West", "North-West"],
    forbidden: ["South-West"],
    priority: "P2",
    remedy: "Study desk must face East; use blue/green tones.",
    science: "Promotes intellectual growth through transient air energy.",
  },
  simple_bedroom: {
    ideal: ["West", "North-West"],
    forbidden: ["South-West"],
    priority: "P2",
    remedy: "Headboard to South; keep South wall heavy.",
    science: "Ensures magnetic alignment of the body during sleep.",
  },
  guest_room: {
    ideal: ["North-West"],
    forbidden: ["South-West"],
    priority: "P3",
    remedy: "Keep the room airy and use light linen.",
    science: "NW (Vayavya) represents transient air; ideal for guests.",
  },
  living_room: {
    ideal: ["North", "East", "North-West"],
    forbidden: ["South-West"],
    priority: "P3",
    remedy: "Keep heavy furniture in South and West side.",
    science: "Common areas benefit from natural morning illumination.",
  },
  dining_room: {
    ideal: ["West", "South"],
    forbidden: ["South-West"],
    priority: "P2",
    remedy: "Mirror on the North wall.",
    science: "Privacy and digestion environment.",
  },
  bathroom: {
    ideal: ["East", "North"],
    forbidden: ["South-West"],
    priority: "P2",
    remedy: "Geyser in the SE corner.",
    science: "East sunlight naturally disinfects damp areas.",
  },
  toilet: {
    ideal: ["North-West", "South"],
    forbidden: ["North-East", "Center"],
    priority: "P2",
    remedy: "Bowl of sea salt inside.",
    science: "Winds carry odors away from the house core.",
  },
  pooja_room: {
    ideal: ["North-East"],
    forbidden: ["South-West"],
    priority: "P1",
    remedy: "Light blue/white walls; no storage.",
    science: "Highest spiritual energy zone.",
  },
  study_room: {
    ideal: ["North-East", "North"],
    forbidden: ["South-East"],
    priority: "P3",
    remedy: "Table faces East.",
    science: "Focus and hygiene.",
  },
  home_office: {
    ideal: ["West", "South-West"],
    forbidden: ["South-East"],
    priority: "P3",
    remedy: "Sit facing North.",
    science: "Professional stability.",
  },
  store_room: {
    ideal: ["North-West", "South-West"],
    forbidden: ["North-East"],
    priority: "P2",
    remedy: "Heavy items in SW corner.",
    science: "Ideal for weight and coolness.",
  },
  laundry: {
    ideal: ["North-West", "South-East"],
    forbidden: ["North-East"],
    priority: "P3",
    remedy: "Drainage to North.",
    science: "Chemical/Moisture handling.",
  },
  staircase: {
    ideal: ["South", "West"],
    forbidden: ["North-East", "Center"],
    priority: "P1",
    remedy: "Odd number steps.",
    science: "Weight represents Earth energy.",
  },
  balcony: {
    ideal: ["North", "East", "North-East"],
    forbidden: ["South"],
    priority: "P3",
    remedy: "Light shrubs only.",
    science: "Ventilation without Southern heat.",
  },
  basement: {
    ideal: ["North", "East", "North-East"],
    forbidden: ["South-West"],
    priority: "P2",
    remedy: "Keep NE corner open to sky.",
    science: "Magnetic-sensitive NE zone.",
  },
  terrace: {
    ideal: ["South", "West"],
    forbidden: ["North-East"],
    priority: "P3",
    remedy: "SW corner highest point.",
    science: "Thermal protection.",
  },
  parking: {
    ideal: ["North-West", "South-East"],
    forbidden: ["North-East"],
    priority: "P3",
    remedy: "Slope to North.",
    science: "Moving Energy zone.",
  },
  garage: {
    ideal: ["North-West", "South-East"],
    forbidden: ["South-West"],
  ...
  garden: {
    ...
    priority: "P3",
    remedy: "Trees in SW.",
    science: "Solar health for plants.",
  },
  water_tank_underground: {
    ideal: ["North-East", "North"],
    forbidden: ["South-West"],
    priority: "P1",
    remedy: "Leakproof tank.",
    science: "Thermal mass in NE.",
  },
  water_tank_overhead: {
    ideal: ["South-West", "West"],
    forbidden: ["North-East"],
    priority: "P1",
    remedy: "Raised platform.",
    science: "Balances magnetic pull.",
  },
  borewell: {
    ideal: ["North-East", "North"],
    forbidden: ["South-West"],
    priority: "P1",
    remedy: "Avoid diagonals.",
    science: "Groundwater access.",
  },
  septic_tank: {
    ideal: ["North-West"],
    forbidden: ["North-East", "Center"],
    priority: "P1",
    remedy: "Away from walls.",
    science: "Gas dissipation.",
  },
  electrical_panel: {
    ideal: ["South-East"],
    forbidden: ["North-East"],
    priority: "P2",
    remedy: "Keep it accessible and clean.",
    science: "Fire element.",
  },
  inverter: {
  ...
  generator_room: {
    ...
    forbidden: ["North-East"],
    priority: "P2",
    remedy: "Soundproofing.",
    science: "Noise isolation.",
  },
  locker: {
    ideal: ["North", "South-West"],
    forbidden: ["South-East"],
    priority: "P1",
    remedy: "Locker door opens North (Kuber).",
    science: "Fortune zone.",
  },
  swimming_pool: {
    ...
    priority: "P2",
    remedy: "Filtration.",
    science: "Microclimate zone.",
  },
  fountain: {
    ideal: ["North-East", "North"],
    forbidden: ["South-East"],
    priority: "P3",
    remedy: "Flow to house.",
    science: "Air ionization.",
  },
};
...
const App = () => {
  ...
  const getAudit = (room) => {
    ...
    if (rule.forbidden.some((f) => zone.includes(f)))
      return { status: "CRITICAL", zone, rule };
    if (!rule.ideal.some((i) => zone.includes(i)))
      return { status: "WARN", zone, rule };
  ...
  const overallScore = useMemo(() => {
    ...
    const total = rooms.reduce((acc, r) => {
      ...
      const score =
        audit.status === "GOOD" ? 100 : audit.status === "WARN" ? 50 : 0;
      const mult =
        audit.rule?.priority === "P1"
          ? 4
          : audit.rule?.priority === "P2"
          ? 2
          : 1;
    ...
    const weightSum = rooms.reduce((acc, r) => {
      ...
      return (
        acc + (rule?.priority === "P1" ? 4 : rule?.priority === "P2" ? 2 : 1)
      );
    }, 0);
  ...
  const handleInteraction = (e) => {
    ...
    const xP = Math.min(
      Math.max(((touch.clientX - rect.left) / rect.width) * 100, 1),
      99
    );
    const yP = Math.min(
      Math.max(((touch.clientY - rect.top) / rect.height) * 100, 1),
      99
    );

    if (draggingId)
      setRooms(
        rooms.map((r) => (r.id === draggingId ? { ...r, x: xP, y: yP } : r))
      );
    if (resizingId) {
      ...
      setRooms(
        rooms.map((item) =>
          item.id === resizingId
            ? {
                ...item,
                widthFt: (newW * plotSize.width) / 100,
                heightFt: (newH * plotSize.length) / 100,
              }
            : item
        )
      );
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `VastuProject_${new Date().getTime()}.vastu`;
    a.click();
  };
  ...
  return (
    <div
      className="flex flex-col h-screen bg-slate-100 font-sans text-slate-900 overflow-hidden select-none"
    ...
    >
      ...
      <header className="bg-white border-b px-4 md:px-8 py-3 flex justify-between items-center z-40 shadow-sm shrink-0 no-print">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            <h1 className="text-xl font-black uppercase tracking-tight">
              VastuSetu <span className="text-indigo-600">Pro 8.0</span>
            </h1>
        ...
        <div className="flex items-center gap-2 md:gap-6">
          ...
          <button
            ...
            className="bg-emerald-600 text-white p-2 md:px-4 md:py-2.5 rounded-xl text-xs font-bold hover:scale-105 transition-all shadow-lg flex items-center gap-2"
          >
          ...
          <div className="flex gap-2 border-l pl-2 md:pl-6">
            <label
              className="cursor-pointer bg-slate-200 text-slate-600 p-2 rounded-xl hover:bg-slate-300 transition-colors"
              title="Import (.vastu)"
            >
              <FileUp size={16} />{" "}
              <input
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <aside
          ...
          } absolute md:relative md:translate-x-0 z-30 w-72 md:w-80 bg-white border-r h-full flex flex-col shadow-xl md:shadow-none transition-transform duration-300 no-print`}
        >
          <div className="p-4 border-b flex gap-1 bg-slate-50 overflow-x-auto scrollbar-hide">
            {CATEGORIES.map((cat) => (
              <button
                ...
                className={`flex-1 min-w-[50px] flex flex-col items-center p-2 rounded-xl transition-all border ${
              ...
              >
                <cat.icon size={14} />
                <span className="text-[8px] font-bold mt-1 uppercase w-full text-center truncate">
                  {cat.label}
                </span>
              </button>
            ))}
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPlotSize({ ...plotSize, width: Number(e.target.value) })
                  }
                  className="w-full p-2 bg-slate-50 rounded-lg text-xs font-bold border border-slate-200"
                />
              </div>
              <div className="space-y-1">
                <label className="text-[8px] font-bold text-slate-400 uppercase ml-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setPlotSize({ ...plotSize, length: Number(e.target.value) })
                  }
                  className="w-full p-2 bg-slate-50 rounded-lg text-xs font-bold border border-slate-200"
                />
              </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 scrollbar-hide">
            <div className="grid grid-cols-3 gap-2 mb-6">
              {ELEMENT_TEMPLATES.filter(
                ...
                >
                  <div
                    className={`w-8 h-8 rounded-lg ${t.color} flex items-center justify-center text-white font-black text-[10px] shadow-sm mb-1 uppercase`}
                  >
                    {t.icon}
                  </div>
                  <span className="text-[7px] font-bold text-slate-600 text-center uppercase tracking-tighter leading-tight">
                    {t.label}
                  </span>
                </button>
              ))}
        ...
        <main className="flex-1 relative flex items-center justify-center bg-slate-200/50 overflow-hidden p-6 md:p-16">
          <button
            ...
            className="md:hidden absolute bottom-6 left-6 z-40 bg-white p-4 rounded-full shadow-2xl border text-indigo-600 no-print"
          >
          ...
          <div
            className={`absolute top-6 right-6 bg-white rounded-[2.5rem] shadow-xl border border-white z-20 transition-all duration-300 no-print ${
              isCompassExpanded ? "w-48 md:w-56 p-5" : "w-12 h-12 p-2"
            }`}
          >
            <button
              onClick={(e) => {
            ...
            {isCompassExpanded && (
              <div className="flex flex-col items-center gap-3 animate-in fade-in slide-in-from-right-4 duration-300">
                <div
                  className="relative w-28 h-28 md:w-36 md:h-36 rounded-full border-4 border-slate-50 flex items-center justify-center bg-white shadow-inner"
                  style={{ transform: `rotate(${northOffset}deg)` }}
                >
                  <div className="absolute -top-1 w-2.5 h-8 bg-rose-600 rounded-full shadow-lg ring-2 ring-white" />
                  <span className="absolute -top-8 font-black text-rose-600 text-2xl">
                    N
                  </span>
                ...
                <div className="w-full text-center">
                  ...
                  <input
                    ...
                    className="w-full h-1.5 bg-slate-100 rounded-lg appearance-none cursor-pointer accent-indigo-600 mt-2"
                  />
                </div>
              </div>
            )}
          ...
          >
            ...
            <div
              className={`absolute inset-0 transition-transform duration-500 pointer-events-none ${
                showZones ? "opacity-30" : "opacity-0"
              }`}
              style={{ transform: `rotate(${northOffset}deg)` }}
            >
              <div className="w-full h-full grid grid-cols-3 grid-rows-3 border-2 border-indigo-100">
                {["NW", "N", "NE", "W", "C", "E", "SW", "S", "SE"].map((z) => (
                  <div
                    key={z}
                    className="border border-indigo-50/50 flex items-center justify-center font-black text-4xl md:text-5xl text-indigo-900/10 uppercase tracking-tighter"
                  >
                    {z}
                  </div>
                ))}
            ...
            {rooms.map((room) => {
              ...
              const t = ELEMENT_TEMPLATES.find(
                (temp) => temp.type === room.type
              );
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[7px] md:text-[9px] font-black text-white text-center leading-none uppercase truncate w-full px-2 tracking-tighter drop-shadow-sm">
                    {room.name}
                  </span>
                  ...
                  {isActive && (
                    <div className="absolute -top-14 left-1/2 -translate-x-1/2 flex gap-2 z-[60] pointer-events-auto bg-white p-1.5 rounded-full shadow-2xl border border-slate-200 no-print">
                      <button
                        ...
                        className="bg-slate-50 p-2 rounded-full shadow-sm hover:text-indigo-600 hover:bg-indigo-50 border text-slate-600"
                        title="Rotate"
                      >
                        <RotateCw size={14} />
                      </button>
                      <button
                        ...
                        className="bg-slate-50 p-2 rounded-full shadow-sm text-rose-500 hover:bg-rose-50 border"
                        title="Delete"
                      >
                        <Trash2 size={14} />
                      </button>
                  ...
                  <div
                    className={`absolute -top-2 -left-2 w-7 h-7 md:w-8 md:h-8 rounded-full border-4 border-white flex items-center justify-center shadow-2xl transform -rotate-[inherit]
                    ${
                      audit.status === "GOOD"
                        ? "bg-emerald-500"
          ...
          {/* <div className="absolute bottom-10 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-xl px-12 py-4 rounded-full border border-slate-200 shadow-2xl flex items-center gap-4 z-10 no-print">
            ...
            <div className="flex flex-col">
              <span className="text-[12px] font-black text-slate-800 uppercase tracking-[0.4em]">
                Design & Audit Studio
              </span>
              <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest leading-none mt-1">
                Mobile & Web Interaction Enabled
              </span>
            </div>
          </div> */}
        </main>
          ...
          <div className="bg-white w-full max-w-5xl h-full md:h-[90vh] rounded-none md:rounded-[2.5rem] shadow-2xl flex flex-col overflow-hidden animate-in fade-in duration-200 print:static print:h-auto print:rounded-none print:shadow-none print:overflow-visible">
            <div className="p-6 md:p-8 border-b flex justify-between items-center bg-emerald-50 shrink-0 no-print">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl md:text-2xl font-black uppercase tracking-tight text-emerald-900">
                    Blueprint Vastu Audit
                  </h2>
                  <p className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest">
                    Generated for current Site Dimensions
                  </p>
                </div>
              </div>
              <div className="flex gap-2">
                <button
                  ...
                  className="bg-slate-900 text-white p-3 rounded-2xl font-bold flex items-center gap-2 shadow-lg hover:scale-105 transition-all"
                >
                  <Printer size={18} /> Print Report
                </button>
                <button
                  onClick={() => setIsReportOpen(false)}
                  className="bg-white p-3 rounded-full hover:bg-slate-50 border"
                >
                  <X />
                </button>
              </div>
            ...
            <div
              id="printable-report"
              className="flex-1 overflow-y-auto p-6 md:p-12 space-y-12 scrollbar-hide print:p-0 print:overflow-visible print:block w-full"
            >
              ...
              <div className="hidden print:block border-b-4 border-slate-900 pb-4 mb-10 w-full">
                <h1 className="text-4xl font-black uppercase text-slate-900 tracking-tighter">
                  VastuSetu Audit Blueprint
                </h1>
                <p className="font-bold text-slate-400 uppercase tracking-widest">
                  Ref No: VS-{new Date().getTime().toString().slice(-6)} • Date:{" "}
              ...
              <div className="relative bg-slate-50 border-2 border-slate-200 rounded-[3rem] p-12 md:p-16 flex items-center justify-center mb-10 shadow-inner print:bg-white print:border-slate-800 print:p-12 print:mb-12 print:break-after-page min-h-[500px] md:min-h-[700px]">
                <div className="w-full h-full flex items-center justify-center min-h-[400px]">
                  ...
                  >
                    ...
                    >
                      <div className="w-full h-full grid grid-cols-3 grid-rows-3 border-2 border-indigo-100">
                        {["NW", "N", "NE", "W", "C", "E", "SW", "S", "SE"].map(
                          (z) => (
                            <div
                              key={z}
                              className="border border-indigo-50/50 flex items-center justify-center font-black text-3xl md:text-4xl text-indigo-900/10 uppercase tracking-tighter"
                            >
                              {z}
                            </div>
                          )
                    ...
                    {rooms.map((room) => (
                      <div
                        key={room.id}
                        className={`absolute flex flex-col items-center justify-center rounded-[0.8rem] md:rounded-[1.2rem] border-2 border-white/50 shadow-lg ${
                          ELEMENT_TEMPLATES.find((t) => t.type === room.type)
                            ?.color
                        }`}
                        style={{
                          left: `${room.x}%`,
                          top: `${room.y}%`,
                          width: `${(room.widthFt / plotSize.width) * 100}%`,
                          height: `${(room.heightFt / plotSize.length) * 100}%`,
                          transform: `translate(-50%, -50%) rotate(${room.rotation}deg)`,
                        }}
                      >
                        <span className="text-[6px] md:text-[9px] font-black text-white uppercase text-center truncate px-1 drop-shadow-sm">
                          {room.name}
                        </span>
                        <span className="text-[5px] md:text-[7px] font-mono text-white opacity-90 mt-0.5">
                          {formatFtIn(room.widthFt)} x{" "}
                          {formatFtIn(room.heightFt)}
                        </span>
                      </div>
                    ))}
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10 print:grid-cols-3 print:gap-4 print:bg-white print:mb-12">
                ...
                <div className="col-span-2 bg-emerald-50 p-8 rounded-[2.5rem] border-2 border-emerald-100 print:bg-white print:border-emerald-500 flex flex-col justify-center">
                  <h4 className="font-black text-emerald-800 uppercase text-xs flex items-center gap-2 mb-3">
                    <ShieldCheck /> Professional Summary
                  </h4>
                  <p className="text-sm leading-relaxed text-emerald-700 font-medium italic">
                    {overallScore > 75
                      ? "Your blueprint demonstrates exceptional alignment with Cardinal Directions. The flow of energy is balanced and auspicious."
                      : overallScore > 50
                      ? "The design is balanced but contains specific Element Conflicts in secondary zones. Implementing the listed remedies will stabilize the environment."
              ...
              <div className="space-y-8 print:p-0 w-full print:block">
                <h3 className="text-2xl font-black uppercase tracking-tight border-b-4 pb-4 border-slate-900 flex items-center gap-3">
                  <Target className="text-indigo-600" size={28} /> Detailed
                  Element Audit
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 print:grid-cols-1 print:gap-8 print:block">
                  {rooms.map((room) => {
                    ...
                    return (
                      <div
                        key={room.id}
                        className={`p-8 rounded-[2rem] border-2 shadow-sm print:break-inside-avoid print:bg-white print:mb-8 ${
                          audit.status === "GOOD"
                      ...
                      >
                        <div className="flex justify-between items-center mb-6">
                          <span className="font-black text-xl text-slate-900 uppercase tracking-tighter">
                            {room.name}
                          </span>
                          <span
                            className={`text-[10px] font-black px-5 py-2 rounded-full text-white uppercase shadow-sm ${
                              audit.status === "GOOD"
                                ? "bg-emerald-500"
                                : audit.status === "CRITICAL"
                                ? "bg-rose-500"
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="bg-indigo-600 p-6 rounded-3xl text-white shadow-xl print:bg-indigo-700">
                                <p className="text-[10px] font-black uppercase opacity-60 mb-2 flex items-center gap-1">
                                  <Wrench size={12} /> Remedial Action (Upay)
                                </p>
              ...
              <div className="hidden print:block pt-16 border-t-2 mt-16 text-center pb-8">
                <p className="text-[10px] font-black uppercase text-slate-300 tracking-[0.6em]">
                  Authorized VastuSetu Elite Report • Sthapatya Veda Division
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-slate-950 text-[9px] text-slate-500 py-2 text-center font-mono uppercase tracking-[0.5em] shrink-0 no-print">
        Blueprint: {formatFtIn(plotSize.width)} x {formatFtIn(plotSize.length)}{" "}
        • Calibration: {northOffset}° • Local Vault Secure
      </div>
    </div>
  );
};
